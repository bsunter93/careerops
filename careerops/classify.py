...
EVENT_PATTERNS = [
    ...
    ("rejection",         [r"\bnot (?:be )?(?:proceeding|moving forward)\b", r"\bmove forward with other\b",
    ...
    ("recruiter_outreach",[r"\bsharing your resume\b", r"\brecruiter\b", r"\breaching out\b"]),
